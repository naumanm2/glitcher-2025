          ...
          <div className="flex flex-col-reverse gap-0 items-start">
            <div className="">
              <p className="p-2 hover:underline">
                <a
                  href={`mailto:${content?.email || "mailto:info@glitcher.info"}`}
                >
                  {content?.email || "info@glitcher.info"}
                </a>
              </p>
              <p className="p-2 hover:underline">
                <a href={`tel:${content?.phone || "tel:+358 45 136 4006"}`}>
                  {parsePhone(content?.phone) || "+358 45 136 4006"}
                </a>
              </p>
            </div>
        ...
        <div className="text-glitcherred w-full scale-[125%] md:scale-110 flex justify-center font-display [&>path]:fill-glitcherpink -my-[7vw] md:-my-[6vw]">
          {content?.secondaryLogo && content.secondaryLogo.asset ? (
            <Image
              ...
              alt={
                content.secondaryLogo.alt || "Main image of Glitcher Collective"
              }
              width={1080}
              height={280}
              className="w-[100vw]"
